...
public class AT1 : AttaqueBoss
{
    ...
    [SerializeField] private GameObject spawnCubeDegat = null;
    ...
    public override void attaqueUpdate()
    {
        ...
        if (timerS <= 0)
        {
            GameObject io = Instantiate(spawnCubeDegat, transform.position + Random.insideUnitSphere * radiusSpawn, Quaternion.identity);
