...
namespace VHS
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject busteP = null;
        [SerializeField] private GameObject cr = null;
        #region Debug
        [Space]
        ...
        protected virtual bool CheckIfRoof() /// TO FIX
        {
            ...
            bool _hitRoof = Physics.SphereCast(_origin, raySphereRadius, Vector3.up, out _roofInfo, m_initHeight / 2.2f);
        ...
        {
            return movementInputData.IsCrouching;
        }
        ...
        IEnumerator crouchAnimeCR(float waitTime,Vector3 currentPos, Vector3 Gotoposition)
        {
            ...
            {
                cr.transform.localPosition = Vector3.Lerp(currentPos, Gotoposition, (elapsedTime / waitTime));
                elapsedTime += Time.deltaTime;

                yield return null;
            }
            cr.transform.localPosition = Gotoposition;
            yield return null;
        }
